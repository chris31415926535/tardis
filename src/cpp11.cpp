...
extern "C" SEXP _tardis_count_punct_cpp11(SEXP em, SEXP qm) {
  BEGIN_CPP11
    return cpp11::as_sexp(count_punct_cpp11(cpp11::as_cpp<cpp11::decay_t<cpp11::integers>>(em), cpp11::as_cpp<cpp11::decay_t<cpp11::integers>>(qm)));
  END_CPP11
}

extern "C" {
static const R_CallMethodDef CallEntries[] = {
    {"_tardis_count_punct_cpp11",                    (DL_FUNC) &_tardis_count_punct_cpp11,                    2},
